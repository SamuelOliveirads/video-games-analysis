...
# video_games_analysis documentation build
...
from video_games_analysis import __version__ as release

# -- Project information -----------------------------------------------------

project = "video_games_analysis"
author = "Kedro"
...
htmlhelp_basename = "video_games_analysisdoc"
...
latex_documents = [
    (
        master_doc,
        "video_games_analysis.tex",
        "video_games_analysis Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "video_games_analysis",
        "Project video_games_analysis codebase.",
        "Nearest-Neighbour",
    )
]
